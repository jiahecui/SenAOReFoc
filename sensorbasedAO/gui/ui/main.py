...
#
# Created: Wed Nov 18 23:21:37 2020
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setWeight(50)
        font.setBold(False)
        self.ZernikeOKBtn.setFont(font)
        ...
        self.ZernikeValSpin.setSingleStep(0.01)
        self.ZernikeValSpin.setProperty("value", 0.0)
        ...
        self.DataCollectBtn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(130)
        sizePolicy.setVerticalStretch(30)
        sizePolicy.setHeightForWidth(self.DataCollectBtn.sizePolicy().hasHeightForWidth())
        self.DataCollectBtn.setSizePolicy(sizePolicy)
        self.DataCollectBtn.setMinimumSize(QtCore.QSize(130, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.DataCollectBtn.setFont(font)
        self.DataCollectBtn.setCheckable(True)
        self.DataCollectBtn.setObjectName("DataCollectBtn")
        ...
        self.miscellaneousLbl = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.miscellaneousLbl.sizePolicy().hasHeightForWidth())
        self.miscellaneousLbl.setSizePolicy(sizePolicy)
        self.miscellaneousLbl.setMinimumSize(QtCore.QSize(170, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.miscellaneousLbl.setFont(font)
        self.miscellaneousLbl.setObjectName("miscellaneousLbl")
        ...
        self.cameraExpoSpin = QtWidgets.QSpinBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cameraExpoSpin.sizePolicy().hasHeightForWidth())
        self.cameraExpoSpin.setSizePolicy(sizePolicy)
        self.cameraExpoSpin.setMinimumSize(QtCore.QSize(50, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.cameraExpoSpin.setFont(font)
        self.cameraExpoSpin.setMinimum(30)
        self.cameraExpoSpin.setMaximum(1000000)
        self.cameraExpoSpin.setSingleStep(10)
        self.cameraExpoSpin.setProperty("value", 40000)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.loopMaxSpin.sizePolicy().hasHeightForWidth())
        self.loopMaxSpin.setSizePolicy(sizePolicy)
        self.loopMaxSpin.setMinimumSize(QtCore.QSize(50, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.focusDepthSpin.setMinimum(-100.0)
        self.focusDepthSpin.setMaximum(100.0)
        self.focusDepthSpin.setSingleStep(0.1)
        ...
        self.stepIncreSpin.setMinimum(-100.0)
        self.stepIncreSpin.setMaximum(100.0)
        self.stepIncreSpin.setSingleStep(0.01)
        ...
        self.stepNumSpin.setMaximum(2000.0)
        ...
        self.startDepthSpin.setMinimum(-100.0)
        self.startDepthSpin.setMaximum(100.0)
        self.startDepthSpin.setSingleStep(0.1)
        ...
        self.pauseTimeSpin.setMaximum(1000.0)
        self.pauseTimeSpin.setSingleStep(0.0001)
        ...
        self.trackBtn.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.serverBtn.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.serverBtn.setFont(font)
        self.serverBtn.setCheckable(True)
        self.verticalLayout_5.addWidget(self.serverBtn)
        self.serverSpin = QtWidgets.QSpinBox(self.centralwidget)
        self.serverSpin.setObjectName("serverSpin")
        font = QtGui.QFont()
        font.setPointSize(10)
        self.serverSpin.setFont(font)
        self.serverSpin.setReadOnly(True)
        self.serverSpin.setMaximum(1)
        self.verticalLayout_5.addWidget(self.serverSpin)
        self.stopRFSpin = QtWidgets.QSpinBox(self.centralwidget)
        self.stopRFSpin.setObjectName("stopRFSpin")
        font = QtGui.QFont()
        font.setPointSize(10)
        self.serverSpin.setFont(font)
        ...
        self.mainContentLayout.addItem(spacerItem2)
        ...
        self.stopBtn.setMinimumSize(QtCore.QSize(300, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        font.setBold(True)
        ...
        self.quitBtn.setMinimumSize(QtCore.QSize(300, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DataCollectBtn.setText(QtWidgets.QApplication.translate("MainWindow", "Data Collection", None, -1))
        ...
        self.miscellaneousLbl.setText(QtWidgets.QApplication.translate("MainWindow", "Miscellaneous", None, -1))
        ...
        self.trackBtn.setText(QtWidgets.QApplication.translate("MainWindow", "TRACK SURFACE", None, -1))
        self.serverBtn.setText(QtWidgets.QApplication.translate("MainWindow", "START SERVER", None, -1))
