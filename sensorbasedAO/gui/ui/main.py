...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stepIncreSpin.setSingleStep(0.1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RFSlider.sizePolicy().hasHeightForWidth())
        self.RFSlider.setSizePolicy(sizePolicy)
        self.RFSlider.setMinimum(-900)
        self.RFSlider.setMaximum(600)
        self.RFSlider.setSingleStep(1)
        self.RFSlider.setProperty("value", 0)
