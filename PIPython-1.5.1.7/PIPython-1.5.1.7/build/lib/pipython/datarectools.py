...
__signature__ = 0x812a5f9587a2b136b3cac95bde0667a
...
def getmaxnumvalues(gcs, usepreset=True):  # 'getmaxnumvalues' is too complex. pylint: disable=R1260
...
class Datarecorder(object):
    ...
    def _get_hdr_options(self):
        ...
        self._recopts, self._trigopts = get_hdr_options(self._gcs)
...
def get_hdr_options(pidevice):
    ...
    @return : Tuple of record and trigger options as lists of integers.
    """
